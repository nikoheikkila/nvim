...
| [obsidian-nvim/obsidian.nvim](https://github.com/obsidian-nvim/obsidian.nvim)                             | Obsidian vault support: wiki-links, backlinks, daily notes (see [Obsidian Vault](obsidian.md)) |
